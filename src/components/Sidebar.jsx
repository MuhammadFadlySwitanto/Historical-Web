...
function Sidebar() {
  ...
  const getNavigationItems = () => {
    ...
    if (userGlobal.level == 5) {
      navigation.push({
        name: "Dashboard",
        icon: <DashboardOutlinedIcon sx={{ fontSize: 24 }} className="flex-shrink-0 m-1 "/>,
        path: "/dashboard",
      },{
        name: "Maintenance",
        icon: <EngineeringIcon />,
        ...
        name: "Instrument",
        icon: <LuPill size={20} className="flex-shrink-0 m-1"/>,
        path: "/Instrument",
      },{
        name: "Utility",
        ...
        name: "Production",
        icon: <FactoryIcon sx={{ fontSize: 24 }} className="flex-shrink-0 m-1 " />,
        path: "/Production",
      },{
        name: "Building",
        ...
        <li key={item.name}>
          {item.subMenu ? (
            <>
              ...
              <button
                className="flex items-center text-left w-full gap-[22px] rounded-md p-[14px] border-none hover:bg-hvrr cursor-pointer bg-none focus:outline-none"
